...
public class Kaprekar {
    ...
    public static int kaprekar(int number) throws SameDigitsException {
        boolean different = false;
        int res = -1;
        int[] digits = { 0, 0, 0, 0 };
        List<Integer> digit = new ArrayList<Integer>();
        ...
        if(!different){
            throw new SameDigitsException("Kaprekar Algorithm: "+number+" contains more than 2 same numbers");
        }
